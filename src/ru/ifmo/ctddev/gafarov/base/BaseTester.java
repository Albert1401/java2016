package ru.ifmo.ctddev.gafarov.base;

import info.kgeorgiy.java.advanced.base.*;
import info.kgeorgiy.java.advanced.base.CG;
...
public class BaseTester {
    ...
    public void run(final String[] args) {
        ...
        System.setProperty(info.kgeorgiy.java.advanced.base.BaseTest.CUT_PROPERTY, args[1]);
    ...
    protected void certify(final Class<?> token, final String salt) {
        try {
            final info.kgeorgiy.java.advanced.base.CG cg = (CG) Class.forName("info.kgeorgiy.java.advanced.base.CertificateGenerator").newInstance();
